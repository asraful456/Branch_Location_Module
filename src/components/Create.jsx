...
export default function Create({ onCreate, onClose }) {
    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
          <h2 className="text-lg font-semibold text-brand-800">Add New Branch</h2>
        ...
        <form onSubmit={handleSubmit} className="px-6 py-5 flex flex-col gap-4">
          <Field label="Branch Name">
            <input
              ...
              className="input-field" placeholder="e.g. Faridpur"
            />
          </Field>
          ...
          <Field label="E-mail">
            <input
              ...
              className="input-field" placeholder="branch@example.com"
            />
          </Field>
          ...
          <Field label="Google Map Link">
            <textarea
              ...
              rows={2} className="input-field" placeholder="<iframe ...></iframe>"
            />
          </Field>
          ...
          <div className="flex gap-3 pt-2">
            <button
              type="submit"
              className="flex-1 bg-brand-600 hover:bg-brand-700 text-white font-medium rounded-md py-2 transition-colors"
            >
              Create Branch
            </button>
            <button
